...
<form action="" class="subasta" method="post" enctype="multipart/form-data" id="subasta">  
...
<input type="submit" class="btn_enviar btn btn-primary" id="btn_enviar" value="Subir Propiedad" onclick="iniciarsub()">        
</form>
